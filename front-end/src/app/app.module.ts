...
import {PurchasesComponentP} from "./componants/purchases-1/purchases.component.p";
import {AddBookComponent} from "./componants/addBook/addbook.component";
import {OrderComComponent} from "./componants/order-comp/order-com.component";
...
const routes: Routes = [
  ...
  // http://localhost:4200/signup
  {path: 'addbook', component:AddBookComponent,canActivate: [RouteActivteService]},
  ...
  //// http://localhost:4200/purchasesp
  {path: 'purchasesp', component:PurchasesComponentP,canActivate: [RouteActivteService]},

  // http://localhost:4200/order/id
  {path: 'order/:id', component:OrderDetailsComponent,canActivate: [RouteActivteService]},

  // http://localhost:4200/order/id
  {path: 'com', component:OrderComComponent,canActivate: [RouteActivteService]},

  // http://localhost:4200/order/id
  {path: 'acc', component:AccountComponent,canActivate: [RouteActivteService]},
